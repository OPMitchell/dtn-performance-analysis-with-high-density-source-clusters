...
This scenario is identical to scenario 2 but the criminals have also set up mobile ``black-hole'' nodes in passing vehicles in an attempt to intercept and prevent the victims' messages reaching the hospital.
