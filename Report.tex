...
\newline Creating custom scenarios involves the editing of the ONE simulator's config files.\\
\newline The ONE Simulator provides a GUI.\\
\newline The ONE Simulator can be extended.\\
